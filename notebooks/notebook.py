...
@app.cell
def _(saving_account_cols, training_data):
...
@app.cell
def _(categorical_cols, identity_features):
    print_without_trunc(
...
@app.cell
def _(categorical_cols, training_data_4):
...
@app.cell
def _(identity_features_2, training_data_6):
...
@app.cell
def _(reduced_test, reduced_train):
...
@app.cell
def _(reduced_test_1, reduced_train_1):
...
@app.cell
def _(all_cols, uncorrelated_train):
...
@app.cell
def _(columns_by_source, uncorrelated_train):
    (
...
@app.cell
def _(most_important_features, uncorrelated_train):
...
@app.cell
def _(correlation_analyzer, most_important_features_importances):
...
@app.cell
def _(correlated_test, correlated_train, tables_analysis, tables_analysis_2):
...
@app.cell
def _(best_features, final_train_1):
